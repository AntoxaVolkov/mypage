...
;(function ($, window, document, undefined) {
	...
	Glide.prototype.swipe = function() {
		...
		if(_.options.wheelBool){
			if (_.parent.context.addEventListener) {
			    if ('onwheel' in document) {
			        // IE9+, FF17+
			        _.parent.context.addEventListener("wheel", function(e){
			        	_.wheel(e)
			        });
			    } else if ('onmousewheel' in document) {
			        // устаревший вариант события
			        _.parent.context.addEventListener("mousewheel", function(e){
			        	_.wheel(e)
			        });
			    } else {
			        // Firefox < 17
			        _.parent.context.addEventListener("MozMousePixelScroll", function(e){
			        	_.wheel(e)
			        });
			    }
			} else { // IE8-
			      	_.parent.context.attachEvent("onmousewheel", function(e){
			        	_.wheel(e)
			        });
			}	
		}
	...
	Glide.prototype.wheel= function(e){
		var _ = this;
